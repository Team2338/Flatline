...
public class RobotMap {
	...
	public static final int CLIMBER_1			= 11; //P: 12 // C: 11
	public static final int CLIMBER_2			= 12; //P: NA // C: 12
	
	// Relay Ports
	public static final int GEAR_HANGER1 		= 2;//P: 2 // C: 2
	...
	public static final int REDSTRIP			= 2;
	public static final int BLUESTRIP			= 3;
