...
// Left Encoder Slaved
public class DriveStraightEnc3 extends Command {
	...
	public DriveStraightEnc3(double inches, double timeout) {
		this(inches, 0.45, timeout);
	}
	
	public DriveStraightEnc3(double inches, double speedCap, double timeout) {
		super(timeout);
